...
### 3) Título: Elección entre almacenamiento relacional vs NoSQL para el módulo de foro de discusión
Este apartado analiza las alternativas entre bases de datos relacionales y NoSQL para el almacenamiento de datos del foro de discusión, con el objetivo de seleccionar la opción más adecuada según las necesidades del sistema.

#### Alternativas

#### 3.1 Almacenamiento Relacional
- **Descripción**: Los datos se organizan en tablas con relaciones definidas, utilizando un esquema rígido (como MySQL o PostgreSQL).
- **Ventajas**:
  - Ofrece consistencia y estructura clara en las relaciones entre datos.
  - Soporta consultas SQL potentes y bien definidas.
  
- **Desventajas**:
  - La rigidez del esquema dificulta la adaptación a cambios en la estructura de datos.
  - No es óptimo para almacenar datos no estructurados o altamente dinámicos, como comentarios y reacciones en tiempo real.
  - Escalabilidad limitada en comparación con las bases de datos distribuidas NoSQL.

#### 3.2 Almacenamiento NoSQL
- **Descripción**: Permite la organización de datos sin un esquema rígido, ofreciendo flexibilidad para almacenar documentos, pares clave-valor, grafos o columnas (como MongoDB o Cassandra).
- **Ventajas**:
  - Alta flexibilidad para manejar datos no estructurados, como comentarios en hilos, interacciones y reacciones de usuarios.
  - Mejor escalabilidad horizontal, lo que facilita el manejo de grandes volúmenes de datos a medida que el foro crece.
  - Soporte para actualizaciones y consultas rápidas, especialmente útil para interacciones en tiempo real.
  
- **Desventajas**:
  - Puede ser menos consistente en ciertos escenarios (eventual consistency).
  - Las consultas pueden ser más complejas en comparación con SQL, requiriendo diseño de modelos de datos optimizados para las consultas más frecuentes.
...
#### Decisión
Se elige el almacenamiento NoSQL.

#### Sustento
El almacenamiento NoSQL es seleccionado debido a su capacidad para manejar datos dinámicos y no estructurados, como los generados por los hilos de discusión y la interacción entre usuarios. Dado que el foro de discusión crecerá en términos de usuarios y volumen de datos, NoSQL ofrece una mejor escalabilidad y flexibilidad. Además, soporta actualizaciones y consultas en tiempo real, lo cual es esencial para una experiencia de usuario fluida en el módulo de foro.
